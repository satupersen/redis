...
namespace Satupersen\Redis\Connectors;

use Satupersen\Contracts\Redis\Connector;
use Satupersen\Redis\Connections\PhpRedisClusterConnection;
use Satupersen\Redis\Connections\PhpRedisConnection;
use Satupersen\Support\Arr;
use Satupersen\Support\Facades\Redis as RedisFacade;
use LogicException;
use Redis;
use RedisCluster;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \Satupersen\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \Satupersen\Redis\Connections\PhpRedisClusterConnection
     */
