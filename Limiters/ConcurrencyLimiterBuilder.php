...
namespace Satupersen\Redis\Limiters;

use Satupersen\Contracts\Redis\LimiterTimeoutException;
...
class ConcurrencyLimiterBuilder
{
     ...
     *
     * @var \Satupersen\Redis\Connections\Connection
     */
    public $connection;
     ...
     * @return mixed
     *
     * @throws \Satupersen\Contracts\Redis\LimiterTimeoutException
     */
