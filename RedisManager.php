...
namespace Satupersen\Redis;

use Closure;
use Satupersen\Contracts\Redis\Factory;
use Satupersen\Redis\Connections\Connection;
use Satupersen\Redis\Connectors\PhpRedisConnector;
use Satupersen\Redis\Connectors\PredisConnector;
use Satupersen\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \Satupersen\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param  \Satupersen\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return \Satupersen\Redis\Connections\Connection
     */
     ...
     *
     * @return \Satupersen\Contracts\Redis\Connector
     */
