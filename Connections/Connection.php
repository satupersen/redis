...
namespace Satupersen\Redis\Connections;

use Closure;
use Satupersen\Contracts\Events\Dispatcher;
use Satupersen\Redis\Events\CommandExecuted;
use Satupersen\Redis\Limiters\ConcurrencyLimiterBuilder;
use Satupersen\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \Satupersen\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \Satupersen\Redis\Limiters\DurationLimiterBuilder
     */
